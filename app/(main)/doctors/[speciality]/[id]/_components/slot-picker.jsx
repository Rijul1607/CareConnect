...
const SlotPicker = ({days,onSelectSlot}) => {
 ...
 return (
  ...
  <TabsList className="w-full justify-start ">
    ...
    <TabsTrigger key={day.date} value={day.date} disabled={day.slots.length===0} className={day.slots.length===0?"opacity-50 cursor-not-allowed":""}>
  ...
  <TabsContent key={day.date} value={day.date} className="pt-4">{day.slots.length===0?(<div className='text-center py-8 text-muted-foreground'> No available time slots for this day</div>
