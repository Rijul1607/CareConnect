  ...
  return (
    ...
    <Script
      ...
      <div className='container mx-auto px-4 py-8'>
        ...
        {isLoading && !scriptLoaded ? <div className='flex flex-col items-center justify-center py-12'>
            <Loader2 className='h-12 w-12 text-emerald-400 animate-spin mb-4'
            /> <p className='text-lg'>Loading video call components...</p> </div>:<div className='space-y-6'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    <div className='border rounded-lg overflow-hidden'>
                        <div className=' bg-emerald-900/10 shadow-[0_0_10px_#34d399] backdrop-blur-sm rounded-md px-3 py-2 text-emerald-400 text-sm font-medium'>
                            You
                        ...
                        {
                            !scriptLoaded && (<div className='flex items-center justify-center h-full'> 
                            <div className='bg-muted/20 rounded-full p-8 shadow-[0_0_10px_#34d399] backdrop-blur-sm'>
            ...
            <div className='flex justify-center space-x-4'>
                ...
                size="lg"
                onClick={toggleVideo}
                className={`rounded-full p-4 h-14 w-14 ${isVideoEnabled ?"border-emerald-900/30 bg-emerald-600 hover:bg-emerald-700":"bg-red-900/20 border-red-900/30 text-red-400 hover:bg-red-900/30"}`}
                ...
                size="lg"
                onClick={toggleAudio}
                className={`rounded-full p-4 h-14 w-14 ${isAudioEnabled ?"border-emerald-900/30 bg-emerald-600 hover:bg-emerald-700":"bg-red-900/20 border-red-900/30 text-red-400 hover:bg-red-900/30"}`}
