...
const DoctorDashboard = async () => {
    ...
    const[appointmentsData,availabiltyData,earningsData,payoutsData]=await Promise.all([
...
<AvailabilitySettings slots={availabiltyData.slots || []}/>
  </TabsContent>
